...
{/if}
<div class="flex-1 relative bg-[#141414] p-2 lg:p-8"><div bind:this={surfaceRef} role="application" aria-label="Polyfield touch surface" class="w-full h-full relative border bg-[#1A1A1A]" on:pointerdown={pointerDown} on:pointermove={pointerMove} on:pointerup={pointerUp} on:pointercancel={pointerUp}>
